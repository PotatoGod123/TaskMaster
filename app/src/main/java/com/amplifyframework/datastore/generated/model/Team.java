...
public final class Team implements Model {
  ...
  private final @ModelField(targetType="TaskModelAmp") @HasMany(associatedWith = "teamID", type = TaskModelAmp.class) List<TaskModelAmp> tasks = null;
  public String getId() {
      return id;
  }
  ...
  public List<TaskModelAmp> getTasks() {
      return tasks;
  }
